...
const CarAgencyManager = {
  ...
  addCarToAgency: function (agencyId, car) {
    ...
    for(let vehicle of agency.cars){ 
        if(car.brand === vehicle.brand){
        vehicle.models.push(car.model); 
        return true; 
        }
    }
    return false; 
...
console.log(CarAgencyManager.printAgency("Best Deal"));